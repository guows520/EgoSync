    ...
    >
      <div className="h-full bg-white shadow-2xl border-l border-slate-200 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {isLoading && (
            <div className="text-center text-[13px] text-slate-400 py-8">加载中...</div>
          )}
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[13px] font-semibold text-slate-700">{n.roleName}</span>
                  </div>
                ...
                <p className="text-[11px] text-slate-400 mt-2">{formatRelativeTime(n.createdAt)}</p>
              </div>
            );
          })}
        </div>
